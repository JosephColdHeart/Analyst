...
---
/* 2. Дать всю имеющуюся информацию о не слишком старых фильмах (не раньше 2010 года) производства Netflix, которые сняли режиссеры пяти главных фильмов 2020 года по версии «КиноПоиска».
...
/* 3. Получить список платформ, у которых неплохой объем продаж в мире и на которых есть выбор шутеров, выпущенных не больше 10 лет назад. Важно, чтобы в отчет попала информация о производителях игр. Также не стоит упускать информацию о деньгах: маркетингу будет полезно увидеть среднюю выручку на одну игру и среднюю выручку на одного производителя. 
